        ...
        {passwordRequirements.map((req) => {
          ...
          return (
            <div key={req.label} className="flex items-center gap-2">
              ...
              <span
                className={`text-xs ${met ? "text-green-600" : "text-muted-foreground"}`}
              >
                {req.label}
              </span>
            </div>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 via-accent to-secondary relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div
              className="absolute bottom-32 right-16 w-96 h-96 bg-accent/40 rounded-full blur-3xl animate-pulse-soft"
          ...
          <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-center">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground text-lg max-w-md mx-auto">
                Create beautiful memory collections from your events and share
              ...
              <div className="flex items-center gap-4 bg-background/80 backdrop-blur-sm rounded-xl p-4 card-elevated">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Guests upload photos via QR code
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4 bg-background/80 backdrop-blur-sm rounded-xl p-4 card-elevated">
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <button
                            ...
                            className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-primary transition-colors z-10"
                          >
                            {showPassword ? (
        ...
        <Dialog open={showConfirmModal} onOpenChange={setShowConfirmModal}>
          <DialogContent className="sm:max-w-md">
            ...
            <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground flex items-start gap-3">
              ...
              <p>
                Once confirmed, you'll be able to sign in and start creating
                events. Can't find the email? Check your spam folder.
              </p>
            </div>
